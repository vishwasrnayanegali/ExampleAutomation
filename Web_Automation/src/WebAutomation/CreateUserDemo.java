...
public class CreateUserDemo {
	...
	public static void main(String[] args) {
		CreateUserTest1.lanuch();
		CreateUserTest1.navigate();
		CreateUserTest1.appLogin();
		CreateUserTest1.minimizepopup();
		CreateUserTest1. userbox();
		CreateUserTest1. modify();
		CreateUserTest1.delete();
		CreateUserTest1.logout();
		CreateUserTest1.close();
	}
